...
should_apply_lto() {
    ...
    case "$STAGENAME" in
        ...
        *"zimg"|*"libtesseract"|*"leptonica"|*"libplacebo"|*"opencl"|*"openvino"|*"opencv"|*"nnedi3"|*"whisper"|*"vapoursynth"|*"libdf"|*"winonnxruntime")
            return 0
            ;;
        # lightweight codecs
        *"giflib"|*"spng"|*"libjpeg-turbo"|*"libpng"|*"libtiff"|*"openjpeg"|*"svtjpegxs"|*"libwebp"|*"libavif"|*"libjxl")
            ...
            ;;
        # other
        *"cdio"|*"cdiowpar"|*"cddb"|*"lensfun"|*"libaribb24"|*"libaribcaption"|*"libass"|*"zvbi"|*"qrencode"|*"quirc"|*"amf"|*"libklvanc"|*"vidstab"|*"libcaca"|*"libudfread"|*"libdvdcss"|*"libdvdread"|*"libdvdnav"|*"libbluray"|*"libomnidrive"|*"libdatachannel"|*"libxxhash")
            return 0
            ;;
